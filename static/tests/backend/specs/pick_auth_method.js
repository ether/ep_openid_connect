...
describe(__filename, function () {
  describe('with no override', function () {
    it('prefers client_secret_post when advertised', async function () {
      assert.equal(
          pickAuthMethod(['client_secret_basic', 'client_secret_post']),
          'client_secret_post');
    });

    it('uses client_secret_basic when only that is advertised', async function () {
      assert.equal(pickAuthMethod(['client_secret_basic']), 'client_secret_basic');
    });

    it('uses client_secret_post when only that is advertised', async function () {
      assert.equal(pickAuthMethod(['client_secret_post']), 'client_secret_post');
    });

    it('ignores unsupported methods', async function () {
    ...
    it('prefers client_secret_post even when other methods are advertised first',
        async function () {
          assert.equal(
    ...
    it('falls back to client_secret_basic when supported is undefined', async function () {
    ...
    it('falls back to client_secret_basic when supported is empty', async function () {
      assert.equal(pickAuthMethod([]), 'client_secret_basic');
    });

    it('falls back to client_secret_basic when supported is not an array', async function () {
  ...
  describe('with override', function () {
    it('honours an explicit client_secret_basic override', async function () {
      assert.equal(
          pickAuthMethod(['client_secret_post'], 'client_secret_basic'),
          'client_secret_basic');
    });

    it('honours an explicit client_secret_post override', async function () {
      assert.equal(
          pickAuthMethod(['client_secret_basic'], 'client_secret_post'),
          'client_secret_post');
    });

    it('honours override even when supported list is missing', async function () {
      assert.equal(
